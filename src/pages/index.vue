<template>
    <div>
                    ...
                    <li class="clearfix">
                        ...
                        <dl>
                            ...
                            <dd v-if="params.consignerAddressId">
                                ...
                                <p>{{params.consignerAddress + params.consignerHouseNumber}}</p>
                            </dd>
                        </dl>
                    ...
                    <li class="clearfix">
                        ...
                        <dl>
                            ...
                            <dd v-if="params.consigneeAddressId">
                                ...
                                <p>{{params.consigneeAddress + params.consigneeHouseNumber}}</p>
                            </dd>
                        </dl>
        ...
        <mt-popup
                ...
                style="width: 100%;">
            <div class="openPop">
                <span @click="openCourier = false">取消</span>
            </div>
...
<script>
  ...
  export default {
    ...
    watch:{
      popParams:{//深度监听，可监听到对象、数组的变化
        handler(val, oldVal){
          //console.log(+val.remark.length, oldVal.remark);//但是这两个值打印出来却都是一样的
          if(val.remark.length>20){
            this.popParams.remark = val.remark.slice(0,20)
          }
        },
        deep:true
      }
      ...
      selectAddress(type){//选择地址
        ...
        YLJsBridge.call('selectAddress',{codeType:2,title:type === 1 ? '寄件人地址薄' : '收件人地址薄'},function(string){
          ...
          if(type == 1){
            ...
            _this.params.consigneeHouseNumber = obj.houseNumber
